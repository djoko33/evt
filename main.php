        ...
        <li>
        	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mon site<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
					<li><a href="vueSite.php">RMPAC-M</a></li>
					<li class="dropdown-submenu"><a href="">TdB PCI</a>
						<ul class="dropdown-menu">
							<li><a href="vueSiteTdb.php?mp=0">General</a></li>
<?php
for ($i = 1; $i < 9; $i++) 
	{

					echo '<li><a href="vueSiteTdb.php?mp='.$i.'">MP'.$i.'</a></li>';
...
<?php
	...
	$s="";
		while ($don = $rep->fetch())
		{											
				echo '<li><a href="vueTramePci.php?code='.$don['code'].'">'.$don['code'].' : '.$don['titre'].'</a></li>';
		}		
...
?>
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mon service<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                	<li class="dropdown-submenu"><a href="#">AUT</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=AUT">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=AUT">TdB</a></li>
						</ul>
                    </li>
                    <li class="dropdown-submenu"><a href="#">CDT</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=CDT">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=CDT">TdB</a></li>
						</ul>
                    </li>
                    <li class="dropdown-submenu"><a href="#">EC</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=EC">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=EC">TdB</a></li>
						</ul>
                    </li>
                    <li class="dropdown-submenu"><a href="#">ECE</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=ECE">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=ECE">TdB</a></li>
						</ul>
                    </li>
                    <li class="dropdown-submenu"><a href="#">EM</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=1_EM">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=1_EM">TdB</a></li>
						</ul>
                    </li>
                    <li class="dropdown-submenu"><a href="#">ING</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=ING">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=ING">TdB</a></li>
						</ul>
                    </li>    
                    <li class="dropdown-submenu"><a href="#">LOG</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=LOG">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=LOG">TdB</a></li>
						</ul>
                    </li>    
                    <li class="dropdown-submenu"><a href="#">MSR</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=MSR">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=MSR">TdB</a></li>
						</ul>
                    </li>
                    <li class="dropdown-submenu"><a href="#">MTE</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=MTE">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=MTE">TdB</a></li>
						</ul>
                    </li>                         
                    <li class="dropdown-submenu"><a href="#">QSPR</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=QSPR">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=QSPR">TdB</a></li>
						</ul>
                    </li>                      
                    <li class="dropdown-submenu"><a href="#">SIR</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=SIR">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=SIR">TdB</a></li>
						</ul>
                    </li>                         
                    <li class="dropdown-submenu"><a href="#">S3P</a>
						<ul class="dropdown-menu">
							<li><a href="vueService.php?serv=S3P">Analyse</a></li>
							<li><a href="vueServiceTdB.php?serv=S3P">TdB</a></li>
						</ul>
                    </li>                        
                </ul>
        </li>			
        ...
        <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mon Sous-Processus<span class="caret"></span></a>
				<ul class="dropdown-menu" role="menu">
					...
					while ($don = $rep->fetch())
						{
						echo '<li><a href="vueSP.php?sp='.$don['sp'].'">'.$don['sp'].'</a></li>';
						}
						$rep->closeCursor();
						echo '</ul>
							</li>';
		...
		<li><a href="vueMot.php" >Mon Mot Cl&eacute;</a>
		</li>
      </ul>
    </div>
  </div>
